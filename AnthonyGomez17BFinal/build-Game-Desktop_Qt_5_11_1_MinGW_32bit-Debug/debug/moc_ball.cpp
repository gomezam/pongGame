...
#include "../../Game-starter-with-update/ball.h"
...
QT_MOC_LITERAL(1, 5, 6), // "Points"
QT_MOC_LITERAL(2, 12, 0), // ""
QT_MOC_LITERAL(3, 13, 4), // "side"
QT_MOC_LITERAL(4, 18, 4) // "Move"

    },
    "Ball\0Points\0\0side\0Move"
};
...
void Ball::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Points((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Ball::Points)) {
                *result = 0;
                return;
            }
        }
